...
const routes = [
  ...
  {
    path: "/databinding/Gugudan",
    name: "GugudanView",
    component: () =>
      import(
        /* webpackChunkName: "databinding", webpackPrefetch:true */ "../views/1_databinding/GugudanView.vue"
      ),
  },
  {
    path: "/databinding/WordRelay",
    name: "WordRelayView",
    component: () =>
      import(
        /* webpackChunkName: "databinding", webpackPrefetch:true */ "../views/1_databinding/WordRelayView.vue"
      ),
  },
  {
    path: "/databinding/Socket",
    name: "SocketView",
    component: () =>
      import(
        /* webpackChunkName: "databinding", webpackPrefetch:true */ "../views/1_databinding/SocketView.vue"
      ),
  },
]
